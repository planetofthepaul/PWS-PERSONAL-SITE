...
title: "How to Keep Your American Phone Number When You Move to Spain (and Why Tello Is Your Best Friend)"
...
## The solution: [Tello](https://www.tello.com) Mobile + a local Spanish carrier

After endless research, I found the setup that actually works. The long term cost is about $8/month for [Tello](https://www.tello.com) plus whatever you pay for a local Spanish plan, and it keeps your US number completely active for texts and calls as if you never left.

Both lines run as eSIMs on my iPhone. No physical SIM cards involved. Here is exactly how I did it.
...
### Sign up for [Tello](https://www.tello.com) Mobile

[Tello](https://www.tello.com) is a budget US carrier that runs on the T Mobile network. Their plans are highly customizable, which makes them perfect for expats.

1. Go to the [Tello](https://www.tello.com) website
...
4. Initiate the porting process to move your existing US number to [Tello](https://www.tello.com). This usually takes a few hours.

### Crucial settings while still in the US

Do not skip this. Once your [Tello](https://www.tello.com) eSIM is activated on your phone:

**Activate Wi-Fi Calling:** Go to Settings > Cellular/Mobile Data > [Tello](https://www.tello.com) > Turn on Wi-Fi Calling.

**Confirm 2FA works:** Try to log into your bank. The code should now arrive via your [Tello](https://www.tello.com) number on your phone.
...
3. Set [Tello](https://www.tello.com) as your **Default Voice Line** (but ensure Data Roaming on [Tello](https://www.tello.com) is **OFF**)
4. Set your data eSIM ([Airalo](https://www.airalo.com) for now) as your **Cellular Data** line. Tap "Cellular Data" at the top of the Cellular settings screen and select the [Airalo](https://www.airalo.com) line.
5. Make sure **Allow Cellular Data Switching** is turned **OFF**. This is important. If you leave it on, your phone might try to use the [Tello](https://www.tello.com) line for data, which you don't want since [Tello](https://www.tello.com) has no data plan. Turning it off forces all data through your [Airalo](https://www.airalo.com) (or later, Spanish carrier) line only.

**The magic:** Because your phone has a Spanish data connection and [Tello](https://www.tello.com) Wi-Fi Calling activated, your [Tello](https://www.tello.com) line will treat the data connection like Wi-Fi. Your US number stays fully active for texts and calls.
...
I've been here a few days and [Airalo](https://www.airalo.com) is doing the job for now, but it's expensive for long term use. The next step is getting a local Spanish prepaid plan. I've heard Digi Mobile has solid prepago deals for around 10 to 15 euros a month with a ton of data. I'll update this post once I've set that up.

The final phone configuration should look like this:

- **[Tello](https://www.tello.com) eSIM:** For US calls and texts. Data Roaming OFF, Wi-Fi Calling ON.
...
I've only been here a few days, but the [Tello](https://www.tello.com) setup is working exactly as promised. My family texts my American number like I never left. It costs them nothing, and it costs me nothing extra beyond the $8/month. When my bank sends a 2FA code, I get it within seconds. My WhatsApp still runs on my US number because I didn't see any point in switching it as it all runs over data anyway.

For $8/month, it's the best peace of mind I've bought for this entire move. If you're moving to Spain, or anywhere abroad, don't rely on Google Voice. Spend the $8 a month on [Tello](https://www.tello.com) and do the dual sim strategy. 
